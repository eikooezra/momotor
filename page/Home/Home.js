      ...
      <View style={styles.Header}>
        ...
        <View style={styles.upperBar}>
          ...
          >
            ...
            />
            <Text style={styles.txtList}>Daftar Produk</Text>
          </TouchableOpacity>
          ...
          >
            ...
            />
            <Text style={styles.txtClist}>Daftar Pesanan</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Calculator")}>
            ...
            />
            <Text style={styles.txtCalc}>Kalkulator Kredit</Text>
          </TouchableOpacity>
        </View>
      </View>
        ...
        {isLoading ? (
          ...
          <>
            <View style={styles.txtPesananTerbaru}>
              <Text style={styles.txtPesanan}>Pesanan Terbaru</Text>
            </View>
            {newOrder.map((item) => {
              return (
                <NewestOrderComponent
                  ...
                  status={item.status}
                  onPressProduct={() =>
                    navigation.navigate("DetailPesanan", item)
                  }
            ...
            <View style={styles.txtLihatContainer}>
              <TouchableOpacity
                onPress={() => navigation.navigate("DaftarPesanan")}
              >
                <Text style={styles.txtLihat}>Lihat Semua</Text>
              </TouchableOpacity>
            </View>
          </>
        )}
